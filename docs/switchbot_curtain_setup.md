...
- CLAP runs Curtain Bluetooth operations on a dedicated Windows worker thread,
  preventing Bleak callbacks from conflicting with the COM mode used by system
  audio control.
